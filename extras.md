...
gsettings set org.gnome.shell enabled-extensions "['dash-to-panel@jderose9.github.com', 'gsconnect@andyholmes.github.io', 'ubuntu-appindicators@ubuntu.com', 'user-theme@gnome-shell-extensions.gcampax.github.com', 'blyr@yozoon.dev.gmail.com', 'focus-my-window@varianto25.com', 'youtube-search-provider@atareao.es', 'alternate-tab@gnome-shell-extensions.gcampax.github.com']"
...
sudo apt install -y audacity caffeine deja-dup deluge-gtk deluge-web deluged galculator galternatives gnome-alsamixer gnome-sushi gnome-usage hardinfo nautilus-dropbox neofetch openssh-server sweeper synaptic tilix unrar vinagre x11vnc #telegram
