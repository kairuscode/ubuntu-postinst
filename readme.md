 ...
 **Problemas não solucionados:**
 ...
 - [x] <span style="color:green">~~Não sei como setar o tema _**Materia-dark-compact**_ para o _shell_ do _**GDM**_.~~</span> [**#gdm-theme-fix**](https://github.com/rauldipeas/ubuntu-postinst/blob/master/postinst.md#gdm-theme-fix)
